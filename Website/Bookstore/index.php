...
if(isset($_SESSION['id'])){
	echo '<header>';
	echo '<blockquote>';
	echo '<a href="index.php"><img src="image/logob.png" width="70px" heigth="70px"></a>';
	...
	echo '<form class="hf" action="editbook.php"><input class="hi" type="submit" name="submitButton" value="Check Out"></form>';
	echo '</blockquote>';
	echo '</header>';
}
...
echo '<blockquote>';
    ...
    while($row = $result->fetch_assoc()) {
	    echo "<td>";
	    echo "<table>";
	   	echo '<tr><td>'.'<img src="'.$row["Image"].'"width="80%">'.'</td></tr><tr><td style="padding: 5px;">Title: '.$row["BookTitle"].'</td></tr><tr><td style="padding: 5px;">ID: '.$row["ISBN"].'</td></tr><tr><td style="padding: 5px;">Author: '.$row["Author"].'</td></tr><tr><td style="padding: 5px;">Type: '.$row["Type"].'</td></tr><tr><td style="padding: 5px;">₱'.$row["Price"].'</td></tr><tr><td style="padding: 5px;">
